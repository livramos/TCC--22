...
namespace ProjetoDudas.Jogo.Fase_2.Resources
{
    class Personagem : PictureBox
    {
        Image ImagemParado;
        Image ImagemMovendo;
...
/*
        ...
        public Personagem(Image ImagemPersonagem, Point initialPoint)
            {
                this.Image = ImagemPersonagem;
            ...
            public Projétil DispararProjétil()
            {
                ...
                {
                    QtdMunição--;
                    Projétil novoProjétil = new Projétil(this.Location);
